...
-- tbl_buyer1 : tbl_book_rent N = 1:다의 관계 이다
-- N의 table에서 FK 설정을 하고 , 1의 table과 관계를 맺는다

ALTER TABLE tbl_book_rent -- N(多,다) table
ADD CONSTRAINT fk_books -- FK이름
...
VALUES(seq_book_rent.NEXTVAL, 
            '2021-05-03', '9791162540640', 'B0001');
...
INSERT INTO tbl_book_rent(br_seq, br_sdate, br_isbn, br_bcode)
VALUES (seq_book_rent.NEXTVAL, '2021-04-20','9791188850549','B0020');
...
-- FK 관계가 설정되지 않는 TABLE 간에서는 조회되는 데이터가 
-- 실제와 다를 수 있다
SELECT 
    br.br_sdate AS 대여일,
    br.br_bcode AS 회원코드,
...
-- FK로 설정되지 않아도 데이터 조회는 모두 할 수 있다,
...
VALUES ( seq_book_rent.NEXTVAL,
            '2021-04-21','B0011','9791188850303');
            
            INSERT INTO tbl_book_rent(br_seq,
            br_sdate, br_bcode, br_isbn)
VALUES ( seq_book_rent.NEXTVAL,
            '2021-04-21','B0011','9791162540527');
