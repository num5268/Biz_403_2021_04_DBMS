...
데이터 무결성 파괴 : 허가된 사용자가 권한이 잘못 
부여되거나, 과도하게 권한을 부여하여
명령을 잘못사용하여 데이터에 문제를 일으키는 것

관리자 권한에서는 최소한으로
테이블스페이스 생성 사용자 생성, 사용자에게 권한부여 
정도만 사용하도록 권장한다.
...
*/ 
CREATE USER testUser IDENTIFIED BY testUser -- 1 문제
