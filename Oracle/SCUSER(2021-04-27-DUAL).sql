...
-- ORACLE에서는 FROM절이 없는 SELECT를 허용하지 않는다
...
-- 단순 문자열 출력
SELECT '2021-04-27' FROM DUAL;

-- 문자열을 연결할때 +를 사용하지 않고 || 를 사용한다
SELECT '2021-04-27' || '11:20:00' FROM DUAL;

-- 실제 날자값으로 변환하여 표현하기
-- 문자열로 되어있는 날짜시간을 실제 Date Type의 데이터로 변환
SELECT to_date
        ('2021-04-27' || '11:20:00','yyyy-mm-ddhh:mi:ss') FROM DUAL;
...
SELECT ROUND (TO_DATE('2021-04-27 11:27:00','YYYY-MM-DDHH:MI:SS'))
FROM DUAL;
