...
-- 실제 20KG의 쌀을 직접 판매하는 것보다 더 비싼 가격에
-- 판매하게 된다
...
테이블을 생성하여 데이트를 IMPORT 하였다

매입매출 데이터와, 상품정보, 거래처 정보를
JOIN하기 위해서는 매입매출 데이터에 상품코드, 거래처코드가
있어야한다.
